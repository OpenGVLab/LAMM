...
class LlavaLlamaModel(LlamaModel):
    ...
    def __init__(self, config: LlamaConfig, mm_vision_tower=None, mm_hidden_size=None, tune_clip=False):
        ...
        if hasattr(config, "mm_vision_tower"):
            # HACK: for FSDP
            self.vision_tower = [CLIPVisionModel.from_pretrained('/data/public/multimodal/multimodal_data/models/openai_clip_large_img_encoder')]
            if tune_clip:
    ...
    def initialize_vision_modules(self, vision_tower, mm_vision_select_layer,
        ...
        image_processor = CLIPImageProcessor.from_pretrained('/data/public/multimodal/multimodal_data/models/openai_clip_large_img_encoder')
