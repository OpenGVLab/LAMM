        ...
        if vision_tower is not None and (input_ids.shape[1] != 1 or self.training) and images is not None:
            ...
            if type(images) is list:
                ...
                for image in images:
                    ...
                    image_forward_out = vision_tower(pixel_values=image, query_embed=self.query, attn_mask=attn_mask)
                    image_forward_out = image_forward_out.reshape(-1, image_forward_out.shape[-1])
